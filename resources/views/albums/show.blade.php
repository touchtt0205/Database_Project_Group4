...
<x-app-layout>
    <x-slot name="header">
        <h2 class="text-center font-semibold text-xl text-white dark:text-gray-200 leading-tight">
            {{ $album->title }}
        </h2>
        <div class="py-5">
                ...
                <div class="bg-gray-800 overflow-hidden shadow-md sm:rounded-lg">
                    <div class="p-6 text-gray-400 ">
                        <div class="font-semibold text-md mb-2 flex justify-between ">
                            ...
                            {{ __('No description ') }}
                            @endif
                            <a href="{{ route('profile.show', $albumOwnerId) }}"
                                class="flex gap-2 text-[16px] font-normal tracking-wide px-4 py-1 inline-block mb-3  bg-red-500 text-white rounded hover:bg-red-700">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="4"
                                    stroke="currentColor" class="size-3 mt-2">
