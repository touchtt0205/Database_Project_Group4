    ...
    <x-slot name="header">
        ...
        <div class="py-1">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-[#355c7d] dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-4 text-gray-100">
                            ...
                            <div class="flex justify-between">
                                ...
                                <div class=" flex mr-5 mt-2">
                                    <form
                                        ...
                                        @method('DELETE')
                                        <button type="submit" class="text-red font-bold py-2 px-2 rounded ">
                                    ...
                                    <p class="mt-2 text-gray-400 tracking-wide">{{ $image->likes()->count()}} Like(s)
                                    </p>
                                </div>
                                <div class="relative mt-2">
                                    ...
                                    <a href="{{ route('images.download', $image->id) }}"
                                        ...
                                        Download Image <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    ...
                                    <a href="{{ route('images.download', $image->id) }}"
                                        class=" tracking-wide flex gap-3 bg-green-500 hover:bg-green-700 text-white font-normal py-2 px-4 rounded">
                                        Download Image (Free) <svg xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <p
                                        class="font-normal flex gap-3 tracking-wide bg-yellow-500 hover:bg-yellow-700 text-white py-2 px-4 rounded">
                                        Can't buy
                                    </p>
                                    @endif
                                    @endif
                        ...
                        <div class="mt-4 tracking-wide">
                            ...
                            <h4 class="mt-3 flex gap-2 text-lg font-bold"> <svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor" class="size-5 mt-1">
                                    <path fill-rule="evenodd"
                        ...
                        <div class="mt-8 tracking-wide">
                            <h4 class="flex gap-2 text-lg font-bold mb-2"><svg xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 24 24" fill="currentColor" class="size-5 mt-1">
                                    <path fill-rule="evenodd"
                            ...
                            <form method="POST" action="{{ route('comments.store', $image->id) }}">
                                ...
                                <div class="mb-3">
                                    <textarea name="content" rows="3"
                                        class="min-h-[40px] w-full rounded border-gray-300 text-gray-500 text-normal"
