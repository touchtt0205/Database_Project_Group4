                                ...
                                <div class="w-full sm:w-1/2 p-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="title" id="title"
                                            class="mt-1 block w-full sm:rounded-lg text-gray-500 text-normal"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea name="description" id="description"
                                            class="mt-1 block w-full sm:rounded-lg min-h-[40px] text-gray-500 text-normal"
                                    ...
                                    <div class="mb-4">
                                        <label for="free" class="inline-flex items-center">
                                            <input type="checkbox" name="free" id="free"
                                                class="form-checkbox sm:rounded-lg" checked
                                    ...
                                    <div class="mb-4" id="max-sales-section" style="display: none;">
                                        <label for="max_sales" class="block  text-gray-100">Max Sales (Leave blank for
                                            unlimited)</label>
                                        <input type="number" name="max_sales" id="max_sales"
                                            class="mt-1 block w-full sm:rounded-lg  text-gray-500 text-normal"
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <label class="inline-flex items-center mr-4">
                                            <input type="checkbox" name="tags[]" value="{{ $tag->tags_id }}"
                                                class="form-checkbox sm:rounded-lg">
