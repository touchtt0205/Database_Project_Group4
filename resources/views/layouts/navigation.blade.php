        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('home') }}">
                        <!-- เปลี่ยนเป็น home แทน dashboard -->
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('order.summary')" :active="request()->routeIs('order.summary')">
                        {{ __('สรุปคำสั่งซื้อ') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
            <div class="px-4">
                ...
                @else
                <div class="font-medium text-base text-gray-800 dark:text-gray-200">ผู้เยี่ยมชม</div>
                @endauth
            </div>
